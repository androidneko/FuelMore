...
import com.androidcat.fuelmore.AppConst;
import com.androidcat.fuelmore.R;
import com.androidcat.fuelmore.entity.FuelMoreEvent;
...
public class LoginActivity extends BaseActivity {
    ...
    private void saveUser(LoginResponse loginResponse){
        ...
        user.userName = loginResponse.getContent().getUserName();
        user.mobile = loginResponse.getContent().getUserName();
